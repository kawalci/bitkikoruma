...
## GitHub Pages Güncelleme Notu

Sayfalar GitHub Pages üzerinde yayınlandığında tarayıcı veya CDN önbelleği nedeniyle CSS/JS değişiklikleri kısa süre eski görünebilir. Bu yüzden HTML dosyalarında `style.css` ve `script.js` bağlantıları sürüm parametresiyle kullanılır.

Örnek:

```html
<link rel="stylesheet" href="style.css?v=20260604-2">
<script src="script.js?v=20260604-2"></script>
```

Yeni stil veya JavaScript değişikliği yaptıktan sonra bu sürüm parametresini artırmak, ziyaretçilerin güncel dosyaları almasına yardımcı olur.
